"""
Portions of this code are derived from pydub (MIT License)
Original Copyright (c) 2011 James Robert
"""
...
class AudioSegment:
    ...
    """
    converter: str | None = shutil.which("ffmpeg")  # either ffmpeg or avconv

    # TODO: remove in 1.0 release
    # maintain backwards compatibility for ffmpeg attr (now called converter)

    USER_CODECS = {"mp3": "libmp3lame"}
    DEFAULT_CODECS = {
        "ogg": "libvorbis"
    }
    ...
    def from_file(cls, file, format=None, codec=None, parameters=None, start_second=None, duration=None, **kwargs):
        ...
        try:
            ...
            filename = None
        file, close_file = _fd_or_path_or_tempfile(file, 'rb', is_temp_file=False)
